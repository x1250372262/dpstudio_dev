package com.dpstudio.dev.qrcode;

import com.dpstudio.dev.qrcode.bean.QrCodeResult;
...
public class QrCodeFactory {
    ...
    private final int defaultMargin = 1;
    private final ErrorCorrectionLevel defaultLevel = ErrorCorrectionLevel.L;
    private boolean createCode;
    private String fileUrl = YMP.get().getConfig().getParam("dpstudio.qr_code.filepath");
    ...
    public QrCodeResult create(String content, String characterSet, int width, int height, int margin, ErrorCorrectionLevel level, String format) throws Exception {
        ...
        format = StringUtils.defaultIfBlank(format, defaultFormat);
