 ...
 * @Description:
 */
public class CurdGenerateImpl extends BaseGenerate implements ICurdGenerate {
    ...
    private static final Log LOG = LogFactory.getLog(CurdGenerateImpl.class);
    ...
    public CurdGenerateImpl(ConfigInfo configInfo) throws IOException {
        ...
        freemarkerConfig.setClassForTemplateLoading(CurdGenerateImpl.class, "/");
