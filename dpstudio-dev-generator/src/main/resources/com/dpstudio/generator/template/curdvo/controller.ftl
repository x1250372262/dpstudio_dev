...
public class ${modelName?cap_first}Controller {
    ...
    */
    ...
    public IView create(<#list fieldList as field><#if (field.varName!"id") != 'id'>@RequestParam ${field.varType} ${field.varName}<#if field_has_next>, </#if></#if></#list>) throws Exception {
        CommonResult commonResult = i${modelName?cap_first}Service.create(<#list fieldList as field><#if (field.varName!"id") != 'id'>${field.varName}<#if field_has_next>, </#if></#if></#list>);
    ...
    */
    ...
    public IView create(<#list fieldList as field>@RequestParam ${field.varType} ${field.varName}<#if field_has_next>, </#if></#list>) throws Exception {
        CommonResult commonResult = i${modelName?cap_first}Service.update(<#list fieldList as field>${field.varName}<#if field_has_next>, </#if></#list>);
        return commonResult.toJsonView();
    }
    ...
    */
    ...
    public IView delete(@VRequired(msg = "ids不能为空")
        ...
        CommonResult commonResult = i${modelName?cap_first}Service.delete(ids);
        return commonResult.toJsonView();
    }
