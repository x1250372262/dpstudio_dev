...
public class TimeHelper {
    ...
    public static long DateTimeHelper(long date, int days) {
     ...
     * @throws Exception
     */
    public static Long getThisMonthFrist() throws Exception {
     ...
     * @throws Exception
     */
    public static Long getNextMonthFrist() throws Exception {
     ...
     * @throws Exception
     */
    public static Long getThisYearFrist() throws Exception {
     ...
     * @throws Exception
     */
    public static Long getNextYearFrist() throws Exception {
     ...
     * @throws Exception
     */
    public static long getDays(int day) throws Exception {
        Long beginTime = DateTimeUtils.currentTimeMillis();//开始时间
