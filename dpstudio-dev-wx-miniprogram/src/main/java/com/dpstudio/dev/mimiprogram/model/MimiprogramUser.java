...
/**
 * MimiprogramUser generated By EntityGenerator on 2020/04/20 下午 12:02:24
 *
 * @author YMP
 * @version 1.0
 */
...
public class MimiprogramUser extends BaseEntity<MimiprogramUser, String> {
	 ...
	 *	@param lastModifyTime
	 */
	public MimiprogramUser(String id, String openId, String unionId, String mobile, String nickName, Integer gender, String avatarUrl, String country, String province, String city, Long createTime, Long lastModifyTime) {
		this.id = id;
		this.openId = openId;
	...
	public static class MimiprogramUserBuilder {
		...
		public MimiprogramUserBuilder mobile(String mobile) {
