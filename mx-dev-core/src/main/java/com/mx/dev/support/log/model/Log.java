...
public class Log extends BaseEntity<Log, String> {
    ...
    public Log(String id, Integer moduleType, String moduleName, Integer type, String action, String resourceId, String content, String createUser, Long createTime) {
        this.id = id;
    ...
    public Log(IDatabase dbOwner, String id, Integer moduleType, String moduleName, Integer type, String action, String resourceId, String content, String createUser, Long createTime) {
        super(dbOwner);
        this.id = id;
        this.moduleType = moduleType;
        this.moduleName = moduleName;
