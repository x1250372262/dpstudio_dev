...
public class BeanUtils {
     ...
     * @return 目标对象
     */
    public static <S, T> IResultSet<T> copyResultSet(IResultSet<S> sources, Supplier<T> target, ClassUtils.IFieldValueFilter fieldValueFilter, BeanUtils.BeanUtilCallBack<S, T> callBack) {
